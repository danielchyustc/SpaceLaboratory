 ...
 * @author DELL
 */
public class FunctionInputPane3<E extends RealVector> extends FIP<E> {
    ...
    private void setLayout(){
        ...
        setBasicButtonPane();
        setFunctionPane();
        StringToFunction[] function = {f1, f2, f3};
    ...
    private void setInputBox(){
        ...
        setF2InputBox();
        setF3InputBox();
        this.getChildren().add(new HBox(20, new VBox(10, new HBox(f1Text, f1InputBox), new HBox(f2Text, f2InputBox), new HBox(f3Text, f3InputBox)), 
    ...
    private void setF3InputBox(){
        f3InputBox.setPrefSize(150, 40);
        f3InsertIndex = f3InputBox.getLength();
        f3InputBox.setOnMouseClicked(e -> {
            f3InsertIndex = f3InputBox.getCaretPosition();
            insertOne = 3;
        });
        f3InputBox.setOnKeyPressed(e -> {
            if(e.getCode() == KeyCode.ENTER) enterAction();
        });
    }
    ...
    private void addBasicButton(String text, int columnIndex, int rowIndex){
        ...
        bt.setOnAction(e -> {
            ...
            if(insertOne == 3) f3InputBox.insertText(f3InsertIndex++, text);
                });
    ...
    private Button deleteButton(){
        ...
        bt.setOnAction(e -> {
            ...
            if(insertOne == 3 && f3InsertIndex > 0) f3InputBox.deleteText(f3InsertIndex - 1, f3InsertIndex--);
                });
        return bt;
    }
    ...
    private void setFunctionBox(){
        ...
        functionBox.setOnAction(e -> {
            ...
            if(insertOne == 3) {
                f3InputBox.insertText(f3InsertIndex, functionBox.getValue() + "()");
                f3InsertIndex += functionBox.getValue().length() + 1;
            }
    ...
    private Button varButton(int i){
        ...
        bt.setOnAction(e -> {
            ...
            if(insertOne == 3) f3InputBox.insertText(f3InsertIndex++, names.get(i));
                });
        return bt;
    ...
    private void enterAction(){
        ...
        f3EnterString = f3InputBox.getText().toLowerCase();
        f3 = new StringToFunction(f3EnterString, names);
        StringToFunction[] function = {f1, f2, f3};
        functionProperty.setValue(function);
    }
    ...
    public StringToFunction<E> getF3(){
        return f3;
    }
    ...
    public String getF3EnterString(){
        return f3EnterString;
    }
}
